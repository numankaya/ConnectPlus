...
// class BogaziciUniversityCommunity extends StatefulWidget {
//   final Function(int) goToPage;

//   const BogaziciUniversityCommunity({required this.goToPage, Key? key})
//       : super(key: key);

//   @override
//   _BogaziciUniversityCommunityState createState() =>
//       _BogaziciUniversityCommunityState();
// }

// class _BogaziciUniversityCommunityState
//     extends State<BogaziciUniversityCommunity> {
...
//                 );
//               }
//               final BogaziciUniversityCommunitys = snapshot.data!.docs;

//               return ListView.builder(
//                 itemCount: BogaziciUniversityCommunitys.length,
//                 itemBuilder: (context, index) {
//                   final data = BogaziciUniversityCommunitys[index].data()
...
//                           onPressed: () async {
//                             await uploadImage();
//                             _fireStore.collection('bogazici').add({
//                               'date': date,
//                               'title': title,
//                               'place': place,
//                               'time': time,
