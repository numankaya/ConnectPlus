import 'package:erasmus_connect/core/utils/color_constant.dart';
import 'package:erasmus_connect/core/utils/image_constant.dart';
import 'package:erasmus_connect/core/utils/size_utils.dart';
import 'package:erasmus_connect/screens/registeration_login/login_screen/login_screen.dart';
import 'package:erasmus_connect/theme/app_style.dart';
import 'package:erasmus_connect/widgets/custom_button.dart';
import 'package:erasmus_connect/widgets/custom_icon_button.dart';
import 'package:erasmus_connect/widgets/custom_image_view.dart';
        ...
        body: Container(
          ...
          child: Form(
            ...
            child: Container(
              ...
              padding: getPadding(left: 39, top: 58, right: 39, bottom: 58),
              child: Column(
                  ...
                  CustomButton(
                      onTap: () {
                        SendForgotPasswordMail(
                            mail: emailController.text, context: context);
                      },
