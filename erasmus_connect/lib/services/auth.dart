...
class FirebaseAuthServiceMethods {
  ...
  Future<bool> signUpWithEmail({required String fullName, required String email, required String password, required BuildContext context}) async{
    try {
  ...
  Future<bool> SignInWithEmail({required String email, required String password, required BuildContext context}) async{
    try {
  ...
  Future<bool> SignInWithGoogle(BuildContext context, {required bool isCreatingAcc, String fullName = ""}) async{
    try {  // Need an optimization
  ...
  Future<void> ForgotPassword({required String mail, required BuildContext context}) async {
    try {
